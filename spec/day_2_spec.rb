...
describe Checksum do
  describe ".checksum" do
    it "returns zero" do
      expect(Checksum.check([])).to eql(0)
    end

    context "given '5 1 9 5 : 7 5 3 : 2 4 6 8'" do
      it "returns 18" do
        test_input = [
          [5,1,9,5],
          [7,5,3],
        ...
        expect(Checksum.check(test_input)).to eql(18)
      end
    end

    context "given solution_input" do
      it "returns 18" do
        solution_input = [
        ...
        expect(Checksum.check(solution_input)).to eql(39126)
      end
    end
  end

  describe ".divisible_checksum" do
    context "given '[]'" do
      it "returns zero" do
        expect(Checksum.divisible_check([])).to eql(0)
      end
    end

    context "given '5 9 2 8 : 9 4 7 3 : 3 8 6 5'" do
      it "returns 18" do
        test_input = [
          [5, 9, 2, 8],
          [9, 4, 7, 3],
        ...
        expect(Checksum.divisible_check(test_input)).to eql(9)
      end
    end
    ...
    context "given solution_input" do
      it "returns 18" do
        ...
        expect(Checksum.divisible_check(solution_input)).to eql(258)
      end
    end
  end
end